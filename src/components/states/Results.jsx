        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '32px', flexWrap: 'wrap' }}>
            ...
            <div style={{ position: 'relative', width: '180px', height: '180px', flexShrink: 0 }}>
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: '22px', fontWeight: 800, color: 'var(--text-primary)' }}>100%</span>
                    <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '10px', color: 'var(--text-muted)' }}>Allocated</span>
                </div>
            </div>
                ...
                {data.map((item, i) => (
                    <div key={i} style={{ padding: '12px 14px', background: 'var(--bg-main)', borderRadius: 'var(--r-md)' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                            ...
                            <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '12px', fontWeight: 600, color: 'var(--text-secondary)' }}>{item.label}</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                            <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: '18px', fontWeight: 800, color: 'var(--text-primary)' }}>{item.value}%</span>
                            <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: 'var(--text-muted)' }}>{item.rupees}</span>
                        </div>
                    </div>
                ))}
            </div>
            ...
            {sectors.map((s, i) => (
                <div key={i}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', fontWeight: 600, color: 'var(--text-primary)' }}>{s.label}</span>
                        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', fontWeight: 700, color: 'var(--text-secondary)' }}>{s.value}%</span>
                    </div>
...
function HealthCircle({ score }) {
    ...
    return (
        <div style={{ position: 'relative', width: '120px', height: '120px', margin: '0 auto' }}>
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: '28px', fontWeight: 800, color: 'white', lineHeight: 1 }}>{pct}</span>
                <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: 'rgba(255,255,255,0.5)' }}>/ 100</span>
            </div>
        </div>
    );
}
        ...
        <div>
            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', marginTop: '10px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: 'var(--text-muted)' }}>Your Portfolio</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: 'var(--text-muted)' }}>Nifty 50</span>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="state-container results-root">
            ...
            <div className="results-header">
                <div>
                    <h1 style={{ fontFamily: "'Outfit', sans-serif", fontSize: '28px', fontWeight: 800, color: 'var(--text-primary)', margin: 0 }}>
                        Analysis Complete
                    </h1>
            ...
            <div className="results-grid">
                ...
                <div className="results-left-col">
                    ...
                    <div className="stat-chips-row">
                        {[
                            ...
                            <div key={i} className="stat-chip">
                                <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-muted)', marginBottom: '8px' }}>{s.label}</div>
                                <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '22px', fontWeight: 800, color: s.positive ? '#A3E635' : 'var(--text-primary)' }}>{s.value}</div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="card-base card-animate card-stagger-1">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '15px', fontWeight: 700, color: 'var(--text-primary)' }}>Asset Allocation</div>
                            <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '10px', fontWeight: 700, color: 'var(--accent)', background: 'var(--accent-light)', padding: '4px 10px', borderRadius: 'var(--r-full)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Live Data</span>
                        </div>
                    ...
                    <div className="card-base card-animate card-stagger-2">
                        <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '15px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '24px' }}>Sector Exposure</div>
                    ...
                    <div className="card-base card-animate card-stagger-3">
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                            ...
                            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '15px', fontWeight: 700, color: 'var(--text-primary)' }}>Key Observations</div>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            {[data.key_observations, data.diversification_concentration].map((obs, i) => (
                                <div key={i} style={{ display: 'flex', gap: '12px', padding: '14px', background: 'var(--bg-main)', borderRadius: 'var(--r-md)' }}>
                                    ...
                                    <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: 'var(--text-secondary)', lineHeight: 1.65 }}>{obs}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="card-base card-animate card-stagger-4" style={{ background: '#FEF2F2', borderColor: '#FECACA' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                            ...
                            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '15px', fontWeight: 700, color: 'var(--text-primary)' }}>Risks & Red Flags</div>
                        </div>
                        <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: '#B91C1C', lineHeight: 1.75, background: 'white', borderRadius: 'var(--r-md)', padding: '14px', border: '1px solid #FCA5A5' }}>
                    ...
                    <div className="card-base card-animate card-stagger-5" style={{ background: '#F7FEE7', borderColor: '#BEF264' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                            ...
                            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '15px', fontWeight: 700, color: 'var(--text-primary)' }}>Improvement Opportunities</div>
                        </div>
                        <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: '#3F6212', lineHeight: 1.75, background: 'white', borderRadius: 'var(--r-md)', padding: '14px', border: '1px solid #BEF264' }}>
                    ...
                    <div className="card-base card-animate card-stagger-6" style={{ background: '#111', border: 'none', position: 'relative', overflow: 'hidden' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '18px', position: 'relative', zIndex: 2 }}>
                            ...
                            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '16px', fontWeight: 700, color: 'var(--lime)' }}>Final Takeaway</div>
                        </div>
                        <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '15px', fontWeight: 600, color: 'white', lineHeight: 1.7, position: 'relative', zIndex: 2 }}>{data.final_takeaway}</p>
                        <div style={{ marginTop: '24px', paddingTop: '20px', borderTop: '1px solid rgba(255,255,255,0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 2 }}>
                            <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: 'rgba(255,255,255,0.3)' }}>Xylar Intelligence Engine</div>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="var(--accent)"><path d="M12 2L14.7 9.3L22 12L14.7 14.7L12 22L9.3 14.7L2 12L9.3 9.3L12 2Z" /></svg>
                        </div>
                    </div>
                ...
                <div className="results-right-col">
                    ...
                    <div className="score-card-v2">
                        <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.12em', color: 'rgba(255,255,255,0.55)', marginBottom: '16px', position: 'relative', zIndex: 2 }}>Portfolio Health</div>
                        <HealthCircle score={data.health_score} />
                        <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', fontWeight: 600, color: 'rgba(255,255,255,0.7)', marginTop: '16px', textAlign: 'center', position: 'relative', zIndex: 2 }}>Good, but needs tweaking</p>
                    </div>

                    {/* Key Signals */}
                    <div className="card-base">
                        <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '14px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '16px' }}>Key Signals</div>
                            ...
                            {data.key_signals && data.key_signals.map((signal, i) => (
                                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: i < data.key_signals.length - 1 ? '1px solid var(--border)' : 'none' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                        ...
                                        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', fontWeight: 500, color: 'var(--text-secondary)' }}>{signal.text}</span>
                                    </div>
                                    <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '12px', fontWeight: 700, color: signalColors[signal.type] || 'var(--text-muted)' }}>{signal.label}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="card-base">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '14px', fontWeight: 700, color: 'var(--text-primary)' }}>1Y Performance</div>
                            <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', fontWeight: 700, color: 'var(--lime)', background: 'var(--positive-light)', padding: '4px 10px', borderRadius: 'var(--r-full)' }}>+14.2%</span>
                        </div>
                        <Sparkline />
                    </div>
                    ...
                    <div className="card-base" style={{ background: 'var(--bg-main)' }}>
                        <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: '14px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '16px' }}>Next Steps</div>
                        <button onClick={onDownload} style={{
                            width: '100%', height: '46px', background: 'var(--accent)', color: 'white',
                            fontFamily: "'Inter', sans-serif", fontSize: '14px', fontWeight: 700, border: 'none',
