            ...
            <div className="landing-columns">
                    ...
                    <div className="card-base">
                        {!hasFile ? (
                            ...
                            >
                                ...
                                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", fontWeight: 500, color: "var(--text-primary)", marginTop: "10px" }}>
                                ...
                                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--accent)", marginTop: "10px", textDecoration: "underline", cursor: "pointer" }}>
                                    or browse files
                                </div>
                            ...
                            <div className="upload-ready">
                                ...
                                <div style={{ flex: 1 }}>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", fontWeight: 600, color: "var(--text-primary)" }}>{fileName}</div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)", marginTop: "2px" }}>File uploaded</div>
                                </div>
                                <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                                    <div onClick={removeFile} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--accent)", fontWeight: 500, textDecoration: "underline", cursor: "pointer" }}>Replace</div>
                                </div>
                            </div>
                        )}
                        ...
                        {!hasFile && (
                            <div style={{ margin: "20px 0", display: "flex", alignItems: "center", gap: "12px" }}>
                                ...
                                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)" }}>or</div>
                                <div style={{ flex: 1, height: "1px", background: "var(--border)" }}></div>
                            </div>
                        )}
                        ...
                        {!hasFile && (
                            <div>
                                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--text-primary)", marginBottom: "8px" }}>
                        ...
                        >
                            ...
                            <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", color: "var(--text-secondary)", fontWeight: 500 }}>
                                Customize analysis
                            </div>
                        ...
                        <div className={`expanded-customize ${customizeOpen ? 'open' : ''}`}>
                            <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", fontWeight: 600, color: "var(--text-secondary)", marginBottom: "10px" }}>
                            ...
                            ></textarea>
                            <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "11px", color: "var(--text-muted)", marginTop: "6px" }}>
                        ...
                        >
                            {hasFile ? "Analyze Portfolio →" : "Continue →"}
                        </button>
                ...
                <div className="landing-right">
                    <div className="card-base" style={{ position: "sticky", top: "36px" }}>
                        <h3 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", fontWeight: 600, color: "var(--text-primary)", marginBottom: "20px" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                            ...
                            <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "14px 0", borderBottom: "1px solid var(--border)" }}>
                                ...
                                <div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--text-primary)" }}>Portfolio Summary</div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)", lineHeight: 1.5, marginTop: "2px" }}>Total picture of your holdings</div>
                                </div>
                            </div>
                            ...
                            <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "14px 0", borderBottom: "1px solid var(--border)" }}>
                                ...
                                <div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--text-primary)" }}>Key Observations</div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)", lineHeight: 1.5, marginTop: "2px" }}>Patterns in your investment behaviour</div>
                                </div>
                            </div>
                            ...
                            <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "14px 0", borderBottom: "1px solid var(--border)" }}>
                                ...
                                <div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--text-primary)" }}>Diversification</div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)", lineHeight: 1.5, marginTop: "2px" }}>Concentration risk and category balance</div>
                                </div>
                            </div>
                            ...
                            <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "14px 0", borderBottom: "1px solid var(--border)" }}>
                                ...
                                <div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--text-primary)" }}>Risks & Red Flags</div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)", lineHeight: 1.5, marginTop: "2px" }}>What to watch for immediately</div>
                                </div>
                            </div>
                            ...
                            <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "14px 0", borderBottom: "1px solid var(--border)" }}>
                                ...
                                <div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--text-primary)" }}>Improvement Opportunities</div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)", lineHeight: 1.5, marginTop: "2px" }}>Where to optimise for better outcomes</div>
                                </div>
                            </div>
                            ...
                            <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "14px 0" }}>
                                ...
                                <div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 600, color: "var(--text-primary)" }}>Final Takeaway</div>
                                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "var(--text-muted)", lineHeight: 1.5, marginTop: "2px" }}>One clear action to take next</div>
                                </div>
                            </div>
