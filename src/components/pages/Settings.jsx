...
function ToggleSwitch({ on = true }) {
    ...
    return (
        <div onClick={() => setIsOn(!isOn)} style={{ width: '44px', height: '24px', borderRadius: '12px', background: isOn ? '#7C3AED' : '#D1D5DB', cursor: 'pointer', position: 'relative', transition: 'background 0.2s' }}>
            <div style={{ width: '18px', height: '18px', borderRadius: '50%', position: 'absolute', top: '3px', left: isOn ? '23px' : '3px', transition: 'left 0.2s', boxShadow: '0 1px 4px rgba(0,0,0,0.15)' }} />
        </div>
    );
}
...
function PillSelect({ options, active }) {
    ...
    return (
        <div style={{ display: 'flex', borderRadius: '9999px', padding: '3px', gap: '2px' }}>
            {options.map(o => (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div className="card-base">
                        ...
                        <SettingRow title="Data Processing" sub="How your portfolio data is used">
                            <span style={{ color: '#3F6212', fontFamily: "'Inter',sans-serif", fontSize: '11px', fontWeight: 600, padding: '4px 12px', borderRadius: '9999px', border: '1px solid #BEF264', whiteSpace: 'nowrap' }}>Session only — not stored</span>
                        </SettingRow>
                        <SettingRow title="Clear Session Data" sub="Remove all temporary data from this session">
                            <button style={{ height: '34px', padding: '0 16px', borderRadius: '9999px', border: '1.5px solid #EF4444', color: '#EF4444', fontFamily: "'Inter',sans-serif", fontSize: '12px', fontWeight: 600, cursor: 'pointer' }}>Clear</button>
                        </SettingRow>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '16px' }}>
                            ...
                            <button onClick={onResetOnboarding} style={{ height: '34px', padding: '0 16px', borderRadius: '9999px', border: '1.5px solid #7C3AED', color: '#7C3AED', fontFamily: "'Inter',sans-serif", fontSize: '12px', fontWeight: 600, cursor: 'pointer', marginLeft: '24px' }}>Reset</button>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', position: 'sticky', top: '76px' }}>
                    ...
                    <div className="card-base">
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                            <div style={{ width: '32px', height: '32px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <span style={{ fontFamily: "'Inter',sans-serif", fontSize: '11px', fontWeight: 600, color: 'var(--text-muted)', padding: '2px 8px', borderRadius: '9999px', marginLeft: 'auto' }}>v1.0.0-beta</span>
                        </div>
                    ...
                    <div className="card-base">
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            <div style={{ width: '36px', height: '36px', borderRadius: '9px', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {/* Disclaimer */}
                    <div className="card-base" style={{ border: '1px solid #FCD34D' }}>
